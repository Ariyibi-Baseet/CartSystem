    ...
    result = {};
        for(let i=0; i<cartList.length; i++)
        {
            ...
            <div class="cart-item">
                ...
                <div>
                <p class="total" id="price${i}">${cartList[i].price}</</</p>
                </div>
            </div> 
            `
...
const myPurchase = (e) => {
    ...
    document.getElementById('cartItemWrapper').innerHTML = "";
    document.getElementById(`finalAmount`).innerText = 0;
    document.getElementById(`deductedAmount`).innerText = 0;
}
...
function stopPropagation()
{
    ...
    document.querySelectorAll('.product-to-cart-btn')[5].addEventListener('click', (e)=>{
        e.stopPropagation();
    })
    document.querySelectorAll('.product-to-cart-btn')[6].addEventListener('click', (e)=>{
        e.stopPropagation();
    })
    document.querySelectorAll('.product-to-cart-btn')[7].addEventListener('click', (e)=>{
        e.stopPropagation();
    })
}
